...
execute as @e[tag=bottle_det0] run data modify block ~ ~ ~ Items insert 0 value {Slot:0b,id:"minecraft:glass_bottle",Count:1b}
execute as @e[tag=bottle_det1] run data modify block ~ ~ ~ Items insert 1 value {Slot:1b,id:"minecraft:glass_bottle",Count:1b}
execute as @e[tag=bottle_det2] run data modify block ~ ~ ~ Items insert 2 value {Slot:2b,id:"minecraft:glass_bottle",Count:1b}
execute as @e[tag=bottle_det3] run data modify block ~ ~ ~ Items insert 3 value {Slot:3b,id:"minecraft:glass_bottle",Count:1b}
execute as @e[tag=bottle_det4] run data modify block ~ ~ ~ Items insert 4 value {Slot:4b,id:"minecraft:glass_bottle",Count:1b}
execute as @e[tag=bottle_det5] run data modify block ~ ~ ~ Items insert 5 value {Slot:5b,id:"minecraft:glass_bottle",Count:1b}
execute as @e[tag=bottle_det6] run data modify block ~ ~ ~ Items insert 6 value {Slot:6b,id:"minecraft:glass_bottle",Count:1b}
execute as @e[tag=bottle_det7] run data modify block ~ ~ ~ Items insert 7 value {Slot:7b,id:"minecraft:glass_bottle",Count:1b}
execute as @e[tag=bottle_det8] run data modify block ~ ~ ~ Items insert 8 value {Slot:8b,id:"minecraft:glass_bottle",Count:1b}